...
class DayItem extends StatefulWidget {
  ...
  const DayItem({Key key, this.day, this.value, this.maxHeight})
      : super(key: key);
...
class _DayItemState extends State<DayItem> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    var barHeight = (widget.maxHeight) * currentValue / 100.0;
    var offsetY = widget.maxHeight - barHeight - 110.0;
    ...
    return Column(
      children: <Widget>[
        ...
        SizedBox(height: 12.0),
        Text(widget.day, style: TextStyle(color: Colors.blueGrey))
      ],
    );
  }
}
